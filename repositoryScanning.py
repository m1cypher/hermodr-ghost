...
class GithubReviewAdmin:
    ...
    def update_review_status(self, accessor, repo_name, file_path, key, value):
        content_repo = self.github.get_user().get_repo(repo_name)
        for review_file in accessor.search("type", value):
            ...
            for line in cleantext.split('\n'):
                ...
                if status_index != -1:
                    ...
                    accessor.update_item_by_id(review_file['id'], {value: status})
        ...
        for review_file in accessor.search("type", value):
            ...
            for line in cleantext.split('\n'):
                ...
                if status_index != -1:
                    ...
                    accessor.update_item_by_id(review_file['id'], {value: imdbId})
        ...
        for review_file in accessor.search("type", value):
            ...
            for line in cleantext.split('\n'):
                ...
                if isbn_index != -1:
                    ...
                    accessor.update_item_by_id(review_file['id'], {value: isbn})
